...
funcion que nos avisa cuando finaliza el renderizado de Angular
  ...
  callback(indexes){
      ...
      this.categories.forEach((category, index)=>{
      	...
      	/*================================================================================ 
       Tomamos la coleccion de las sub-categorias filtrando con los nombres de categorias
      ====================================================================================*/
       ...
       .subscribe(resp=>{
       	...
       	/*=====================================================
         Recorremos el array de objetos nuevo para buscar coincencias
         con los nombres de categorias
       	=======================================================*/
       ...
       /*====================================================
       Tomamos la coleccion de los productos filtrando con las
       url's de categoria
       ======================================================*/
       ...
       .subscribe(resp=>{
         ...
         =======================================================================================*/
          for(i in arrayProducts){
          	...
          	if(category.url == arrayProducts[i].category){
               ...
               /*======================================================
               Definamos si el precio del producto tiene oferta o no
               ======================================================*/
        ...
        for (let f = 0; f < JSON.parse(arrayProducts[i].reviews).length; f++){
             ...
             totalReview += Number(JSON.parse(arrayProducts[i].reviews)[f]["review"])
              ...
              /*=================================
              Ìmprimimos el total de las calificaciones para cada producto
               ====================================*/
              ...
              Imprimimos los productos en el HTML
               ====================================*/
          		...
          		/*=====================================================
                 Clasificamos la cantidad de estrellas segun la calificacion 
          		======================================================*/
